#!/usr/bin/env python3
"""
UMBRA PRIVACY - MAIN MENU
Central menu system for Umbra Privacy automation
"""
import os
import sys
import asyncio
...
░░░╚═╝░░░╚═╝░░╚═╝░╚════╝░░╚═════╝░░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝╚═╝░░╚═╝░╚═════╝░╚═════╝░
    ...
    print_border("CONTINUUM WAITLIST - AUTO REFERRAL", Fore.GREEN)
...
async def run_autoreff(language: str):
    from scripts.autoreff import run_autoreff
    await run_autoreff(language)
...
def get_available_scripts(language):
    scripts = {
        'vi': [
            {"name": "1. Tự động giới thiệu bạn bè", "value": "autoreff"},
            {"name": "X. Thoát", "value": "exit"},
        ],
        'en': [
            {"name": "1. Auto Referral", "value": "autoreff"},
